...
const NODE_FLOW = ['Intro', 'Verify Identity', 'Inform Balance', 'Negotiate', 'Part Payment', 'Confirm Details', 'Close'];
    ...
    const load = async () => {
      try {
        const [sRes, tRes, mRes] = await Promise.all([
          ...
          conversationsApi.getTranscript(params.id),
          conversationsApi.getMetrics(params.id),
        ]);
          ...
          <div className="flex items-center gap-4">
            ...
            <div>
              ...
              <div className="flex items-center gap-2 mt-1 flex-wrap">
                ...
                <span className="text-[#475569] text-xs font-mono">{params.id}</span>
              </div>
            </div>
          </div>
          ...
          {session.commitment_amount && (
            <div>
              ...
              <div className="flex items-center gap-1 text-emerald-400 font-medium">
                <IndianRupee size={13} />
                {formatCurrency(session.commitment_amount).replace('₹', '')}
              </div>
            </div>
          )}
      ...
      <div className="grid grid-cols-1 lg:grid-cols-5 gap-5">
        ...
        <div className="lg:col-span-3 bg-[#1a1d24] rounded-xl border border-[#2a2d38]">
          <div className="px-5 py-4 border-b border-[#2a2d38]">
            <h3 className="text-[#f1f5f9] font-semibold text-sm flex items-center gap-2">
              <FileText size={15} className="text-[#475569]" />
              Full Transcript
            </h3>
          </div>
        ...
        <div className="lg:col-span-2 space-y-4">
          ...
          <div className="bg-[#1a1d24] rounded-xl border border-[#2a2d38]">
            <div className="px-5 py-4 border-b border-[#2a2d38]">
              <h3 className="text-[#f1f5f9] font-semibold text-sm flex items-center gap-2">
                <GitBranch size={15} className="text-[#475569]" />
                Flow Path
              </h3>
            </div>
            <div className="p-5">
          ...
          {metrics && (
            <div className="bg-[#1a1d24] rounded-xl border border-[#2a2d38]">
              <div className="px-5 py-4 border-b border-[#2a2d38]">
                <h3 className="text-[#f1f5f9] font-semibold text-sm flex items-center gap-2">
                  <Bot size={15} className="text-[#475569]" />
                  Session Metrics
                </h3>
              </div>
